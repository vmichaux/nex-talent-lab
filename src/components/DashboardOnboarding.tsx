    ...
    switch (currentStep) {
      ...
      case 2:
        return <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg mb-8">Are you a talent looking for opportunities or an entrepreneur with a project?</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-10">
              ...
              <Card 
                className={`cursor-pointer transition-all hover:shadow-md ${
                  selectedRole === 'entrepreneur' ? 'ring-2 ring-secondary' : ''
                }`}
