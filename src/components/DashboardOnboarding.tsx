              ...
              <Card className={`cursor-pointer transition-all hover:shadow-md ${selectedRole === 'both' ? 'ring-2 ring-primary' : ''}`} onClick={() => setSelectedRole('both')}>
                <CardContent className="flex flex-col items-center p-4 bg-[#F3F1FF] h-[180px] py-[9px]">
                  ...
                  <div className="mt-auto text-center">
                    ...
                    <p className="text-center text-muted-foreground">Both contribute your skills to projects and create your own initiatives. Ideal for versatile professionals who want to explore all opportunities.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
