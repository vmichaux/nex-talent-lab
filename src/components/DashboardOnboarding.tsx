      ...
      case 1:
        return <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <div className="mb-10 text-center max-w-prose">
              <p className="mb-6 px-[38px]">NexTalent Lab is a platform that connects emerging talent with project builders. Whether you're looking to build your portfolio or find the perfect 
collaborator for your project, we're here to help.</p>
              <p className="mb-8">
