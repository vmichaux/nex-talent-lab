...
export const ChatWidget = () => {
  ...
  return <>
      {!isOpen && <Button 
          ...
          className="fixed bottom-6 right-20 z-50 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 bg-primary/80 hover:bg-primary text-white transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2" 
          size="icon"
        >
