          ...
          <Card key={item.id} className="shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent className="space-y-3 px-4 pb-4">
              <div className="flex justify-between items-center">
                ...
                <Badge className={
                  item.status === "On Track" ? "bg-green-100 text-green-800 hover:bg-green-100 text-xs px-2 py-0.5" :
                  item.status === "At Risk" ? "bg-yellow-100 text-yellow-800 hover:bg-yellow-100 text-xs px-2 py-0.5" :
