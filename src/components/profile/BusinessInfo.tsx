...
export const BusinessInfo = ({ business, onBusinessChange }: BusinessInfoProps) => {
  return (
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onBusinessChange("foundedYear", e.target.value)}
              placeholder="2015"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => onBusinessChange("employees", value)}
            >
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onBusinessChange("industry", e.target.value)}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => onBusinessChange("projectNeeds", e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => onBusinessChange("billingDetails", e.target.value)}
