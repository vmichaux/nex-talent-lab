...
export function PricingSection() {
  const plans = [{
    ...
    icon: <User className="h-5 w-5 text-primary mb-2 mr-3" />,
    ...
    icon: <Building2 className="h-5 w-5 text-primary mb-2 mr-3" />,
    ...
    icon: <Rocket className="h-5 w-5 text-purple-500 mb-2 mr-3" />,
