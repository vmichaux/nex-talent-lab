  ...
  return <div className="relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 md:py-32 py-[100px]">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="mb-10 text-lg text-gray-600 md:text-xl max-w-3xl whitespace-normal">NexTalent Lab brings together creative talents and project builders for meaningful collaborations that drive growth and elevate each other. </p>
